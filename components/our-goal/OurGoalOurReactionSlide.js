...
const OurGoalOurReactionSlide = ({ slide }) => {
  ...
  return (
    <div className="p-8 text-center mb-8 m-4 flex flex-col justify-between items-between border border-gray-light shadow-xl" style={{ flex: "1", height: "380px", borderBottom: `6px solid ${borderColor()}`}} >
