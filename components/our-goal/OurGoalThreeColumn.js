...
const OurGoalThreeColumn = ({ blok }) => {
  return (
    <div className="three-column flex xs:p-4 md:px-8 md:py-[90px] flex-col bg-gray-extra-light" style={{paddingBottom: "80px" }}>
        <div className="py-8 text-4xl font-bold flex justify-start items-center w-full">{render(blok.title)}</div>
