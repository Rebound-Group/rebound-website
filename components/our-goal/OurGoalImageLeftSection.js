...
const OurGoalOurImageLeftSection = ({ blok }) => {
  ...
  return (
    <div className="p-8 flex" >
        ...
        <div className="flex justify-between items-center mt-12 pt-12" style={{ borderTop: "1px solid black"}}>
        <div className="text-2xl">{render(blok.cta_text)}</div>
        <a className="text-2xl ml-4" href={blok.cta_link.url}><img style={{height: "50px", width: "50px"}} src="/arrow_right.svg" /></a>
        </div>
