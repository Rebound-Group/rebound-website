      ...
      >
        <div className="flex flex-col">
          ...
          <div className="flex justify-center items-center text-center">
            <div className="p-4 mx-4 bg-three-box-panel flex flex-col">
              <div className="xs:pl-2 lg:pl-8 lg:mb-0 text-grey font-bold text-3xl mb-4">
                {render(blok.BoxTitle1)}
                <span className="text-melon">.</span>
              </div>
              <div className="xs:pl-2 lg:pl-8 lg:mb-0 text-md">
