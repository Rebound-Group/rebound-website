...
const GovernanceList = ({ blok }) => {
  return (
    <div className="GoveranceList bg-white font-sans xs:p-4 lg:p-12 pt-4 w-full md:w-3/4" >
        {blok.governance_link_item.map((item, i) => (
                <a className="my-6 p-4 shadow-lg shadow-gray-950 rounded flex flex-col" key={i} target="_blank" href={item?.link.filename}>
